...
import com.example.EcommerceStore.service.impl.StaffService;
...
public class StaffController {
  ...
  @GetMapping("/edit/{id}")
  public String showEditStaffForm(@PathVariable int id, Model model, HttpSession session) throws Exception {
    if ((boolean) session.getAttribute("admin")!=true)
      return "error";
